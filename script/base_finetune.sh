...
train_input_file=data/marco/train.concept.tar.gz  #训练数据
dev_input_file=data/ohsumed/dev.concept.tar.gz  #测试数据
test_input_file=data/marco/dev.concept.dl2019.tar.gz
